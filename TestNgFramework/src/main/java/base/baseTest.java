...
public class baseTest {
    ...
    public void beforeSuite() {
        sparkReporter = new ExtentSparkReporter(System.getProperty("user.dir") + File.separator + "reports" + File.separator + "Automation.html");
        ...
        sparkReporter.config().setReportName("Automation Test Results by QA Team");
